...
def main() -> int:
    ...
    paths = [line for line in str(git(root, "ls-files")).splitlines() if line]
    ...
    document = {
        ...
        "name": f"pleiades-factory-stack-{args.version}",
        "documentNamespace": f"https://github.com/Zheke32174/pleiades-factory-stack/sbom/{commit}",
        "creationInfo": {
            "created": created,
            "creators": ["Tool: scripts/write_spdx_sbom.py"],
        },
        "packages": [
            {
                "name": "pleiades-factory-stack",
                ...
                "licenseDeclared": "MIT",
                "copyrightText": "Copyright (c) 2026 Fixxia",
                "externalRefs": [
                    {
                        "referenceCategory": "PACKAGE-MANAGER",
                        "referenceType": "purl",
                        "referenceLocator": f"pkg:github/Zheke32174/pleiades-factory-stack@{commit}",
                    }
                ],
            }
        ],
